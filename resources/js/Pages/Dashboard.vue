...
//to run the delete request with inertiajs (router.delete)
...
<template>
                            ...
                            <td class="w-3/4 p-3 text-left">
                                <div class="flex items-center gap-2">
                                    ...
                                    <h4 class="font-bold">
                                        {{ listing.title }}
                                        <i
                                            :class="listing.approved ? 'fa-solid fa-circle-check text-green-500' : 'fa-solid fa-circle-xmark text-red-500'"></i>
                                    </h4>
                                </div>
                            </td>
    ...
    <!-- If the listings are not available, show the message on page said that the account has been suspended -->
    <div v-else>
