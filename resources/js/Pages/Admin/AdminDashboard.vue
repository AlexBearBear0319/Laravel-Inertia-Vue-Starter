...
<template>
    ...
    <div class="flex items-end justify-between mb-4">
        <div class="flex items-end gap-2">
            ...
            <Link class="px-2 py-[6px] rounded-md bg-indigo-500 text-white flex items-center gap-2" v-if="params.search"
        ...
        <div class="flex items-center gap-1 text-xs hover:bg-slate-300 dark:hover:bg-slate-800 px-2 py-1 rounded-md">
            ...
            <input @input="toggleRole" :checked="params.user_role" type="checkbox" id="toggleRole"
